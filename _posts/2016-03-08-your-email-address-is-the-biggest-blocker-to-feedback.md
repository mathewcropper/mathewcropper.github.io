...
There comes a point where there are just too many paper cuts, and your users give up.
...
If your users are put off from sharing their problems, how do you expect to encourage a culture of sharing ideas? Like I said, once someone has enough paper cuts, they just go quiet.
...
There are a whole bunch of advantages when you do this:

* Users stay in your app!
* Users feel like you care about them, by asking just one question - can you describe your problem?
* You can capture all kinds of background information, and never once confuse your user by showing it. For example, device info, app info, user info etc.
* If you use push notifications, you can bring users back to your app when you solve their problem.
* Their perception of your company improves massively. You have your act together, and a clear focus on user experience.
...
[Zendesk](http://gocrop.it/zendesk) offers [embeddable support](http://gocrop.it/embeddables) for mobile and the web, allowing a quick and easy way to get started. If you're keen on building your own custom look, feel, and workflow, you can do that as well. Take a look [here](http://gocrop.it/swiftkey) to see how SwiftKey use Zendesk's SDK for exactly this purpose.

If you have built your own support system, speak with your technical team about which parts of that are available via an API. Start with a best case scenario user experience, and see what they can do for you. It's surprising how much value it brings.

---------------
*This post was originally published on [LinkedIn](https://www.linkedin.com/pulse/your-email-address-biggest-blocker-getting-awesome-feedback-cropper?trk=mp-author-card)*
